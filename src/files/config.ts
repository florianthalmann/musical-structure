...
export const GD_AUDIO = "/Users/flo/Projects/Code/FAST/musical-structure/data/good_lovin'/"//'/Volumes/gspeed1/thomasw/grateful_dead/lma_soundboards/sbd/' //'data/goodlovin/';
