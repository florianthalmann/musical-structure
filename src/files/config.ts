...
export const GD_AUDIO = '/Users/flo/Projects/Code/FAST/musical-structure/data/box_of_rain/'//'/Volumes/gspeed1/thomasw/grateful_dead/lma_soundboards/sbd/' //'data/goodlovin/';
